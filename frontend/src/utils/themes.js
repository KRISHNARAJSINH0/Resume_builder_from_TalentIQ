...
export const UI_THEMES = {
  ...
  // ── 6. Arctic Frost (Glassmorphism White) ──────────────────────────────────
  'arctic-frost': {
    id: 'arctic-frost',
    name: 'Arctic Frost',
    emoji: '❄️',
    description: 'Clean white glassmorphism with sky-blue accents — crisp and premium.',
    preview: ['#f0f6ff', '#0ea5e9', '#6366f1'],
    vars: {
      '--bg':           '#f0f6ff',
      '--s1':           'rgba(255,255,255,0.85)',
      '--s2':           'rgba(255,255,255,0.65)',
      '--s3':           'rgba(255,255,255,0.45)',
      '--border':       'rgba(255,255,255,0.70)',
      '--border-focus': 'rgba(14,165,233,0.50)',
      '--b2':           'rgba(255,255,255,0.90)',
      '--text':         '#0f172a',
      '--text-soft':    '#334155',
      '--muted':        '#64748b',
      '--v':            '#0ea5e9',
      '--v-glow':       'rgba(14,165,233,0.20)',
      '--v-light':      'rgba(14,165,233,0.10)',
      '--v-deep':       '#0284c7',
      '--t':            '#06b6d4',
